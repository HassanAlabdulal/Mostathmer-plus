  ...
  return (
    <div className="p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mt-16 ">
          <h2 className="text-center text-2xl font-semibold my-4">{investment?.title}</h2>
        </div>
        ...
        <Card className="flex items-center justify-center hover:bg-[#f1f1f1] dark:hover:bg-[#27272a] min-h-[300px] max-h-[500px] col-span-1 md:col-span-2">
        ...
        />
          ...
          <Card className="flex items-center justify-center hover:bg-[#f1f1f1] dark:hover:bg-[#27272a] h-32 col-span-1 md:col-span-2">
            <CardContent>
              <p className="text-center"><strong>الوصف التفصيلي:</strong> <br /> {investment?.Description}</p>
            </CardContent>
          </Card>
          ...
          <Card className="flex items-center justify-center hover:bg-[#f1f1f1] dark:hover:bg-[#27272a] h-32">
            <CardContent>
              <p className="text-center mt-5"><strong>نوع الاستثمار:</strong> <br />  {investment?.investmentType}</p>
            </CardContent>
          </Card>
          ...
          <Card className="flex items-center justify-center hover:bg-[#f1f1f1] dark:hover:bg-[#27272a] h-32">
            <CardContent>
              <p className="text-center mt-5"><strong>تكلفة المشروع:</strong> <br /> {investment?.Coast}</p>
            </CardContent>
          </Card>
          ...
          <Card className="flex items-center justify-center hover:bg-[#f1f1f1] dark:hover:bg-[#27272a] h-32">
            <CardContent>
              <p className="text-center mt-5"><strong>موقع الاستثمار:</strong> <br />  {investment?.investmentLocation}</p>
            </CardContent>
          </Card>
        ...
        <Card className="flex items-center justify-center hover:bg-[#f1f1f1] dark:hover:bg-[#27272a] h-32">
            <CardContent>
              <p className="text-center mt-5"><strong>المدة الزمنية:</strong> <br />  {investment?.Date}}</p>
            </CardContent>
          </Card>
          ...
          <Card className="flex items-center justify-center hover:bg-[#f1f1f1] dark:hover:bg-[#27272a] h-32 col-span-1 md:col-span-2">
            <CardContent>
              <p className="text-center mt-5"><strong>معلومات الاتصال:</strong> <br />  {investment?.Contact}</p>
            </CardContent>
          </Card>
        </div>
      </div>
