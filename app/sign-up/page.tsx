...
export default function SignUp() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (formData.passwordSignUp !== formData.passwordConfirm) {
      setErrors({ ...errors, passwordConfirm: "كلمة المرور وتأكيد كلمة المرور لا تتطابقان" });
        ...
        <form onSubmit={handleSubmit}>
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <Input name="emailSignUp" id="emailSignUp" type="email" placeholder="mostathmerplus@gmail.com" onChange={handleChange} />
