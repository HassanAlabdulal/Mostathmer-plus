...
const FAQList: FAQProps[] = [
  {
    ...
    answer:
      "لا والله، ما يحتاج! تقدر تلقى نظرة على كل الفرص بدون تسجيل. بس علمك، إذا بغيت تحفظ فرص معينة أو تضيف استثماراتك، يبغالك تسجل معنا.",
    value: "faq-1",
  },
  {
    question: "كيف أقدر أضيف استثماري على الموقع؟",
    answer:
      "والله الأمر مرة سهل! بس تسجل وتعبي تفاصيل استثمارك وعليها بالعافية، يصير متاح لكل الناس يشوفونه.",
    value: "faq-2",
  },
  {
    question: "أبغى أعرف كل التفاصيل عن فرصة معينة، كيف؟",
    answer:
      "اضغط على الفرصة اللي شدتك، وبتلاقي كل صغيرة وكبيرة عنها، من معلومات وأرقام، كله موجود يا معلم.",
    value: "faq-3",
  },
  {
  ...
  },
  {
    ...
    answer:
      "شوف يا سيدي، إحنا نوفر لك المعلومات، بس القرار يبقى لك. نصيحة منا، دايم اسأل مستشارك المالي قبل ما تتخذ خطوة.",
    value: "faq-5",
  },
  {
    question: "لو حبيت أتواصل مع صاحب فرصة، كيف الطريقة؟",
    answer:
      "سهلة! داخل صفحة كل فرصة فيها خيار تتواصل مع صاحب العرض مباشرة. اضغط وابدأ السواليف.",
    value: "faq-6",
  },
  {
  ...
  },
  {
    ...
    answer:
      "لا يا طويل العمر، المشاهدة مجانية وإضافة الاستثمارات كمان. نبغى الف",
    value: "faq-8",
  },
];
